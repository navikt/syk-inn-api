...
object SykmeldingTable : Table("sykmelding") {
    ...
    val metaBehandlerIdent = text("meta_behandler_ident").nullable()
    ...
    val metaOrgnummer = text("meta_orgnummer").nullable()
    val metaTelefonnummer = text("meta_telefonnummer").nullable()
    ...
    val valuesPrognose = jacksonJsonb<SykmeldingJsonbPrognose>("values_prognose").nullable()
