...
@Component
class ScheduledTasks(private val sykmeldingService: SykmeldingService) {
    ...
    fun deleteOldSykmeldinger() {
        ...
        val deletedCount = sykmeldingService.deleteSykmeldingerOlderThanDays(DAYS_OLD_SYKMELDING)
