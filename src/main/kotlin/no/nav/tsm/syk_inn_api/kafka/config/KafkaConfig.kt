package no.nav.tsm.syk_inn_api.kafka.config

import no.nav.tsm.syk_inn_api.kafka.model.sykmelding.SykmeldingRecord
import no.nav.tsm.syk_inn_api.kafka.model.sykmelding.util.SykmeldingDeserializer
import no.nav.tsm.syk_inn_api.kafka.model.sykmelding.util.SykmeldingRecordSerializer
